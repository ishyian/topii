...
class MessageAdapter @JvmOverloads constructor(
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        if (type == RECEIVED) {
            viewHolder.message_box?.setBackgroundResource(R.drawable.bg_chat_incoming_message)
            if (isInValidSession) {
        ...
        if (type == SENT) {
            viewHolder.message_box?.setBackgroundResource(R.drawable.bg_chat_outgoing_message)
        }
