...
import com.topiichat.core.exception.data.model.NoNetworkConnectionException
...
import com.topiichat.core.presentation.error.ErrorParameters
import com.topiichat.core.presentation.error.ErrorScreens
...
abstract class BaseViewModel(private val router: Router) : ViewModel(), IBaseViewModel {
    ...
    private fun showErrorScreen(error: Error) {
        navigate(ErrorScreens.Error(ErrorParameters(error)))
    }
